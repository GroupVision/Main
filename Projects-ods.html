      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          ...
          <!-- End Single Category -->
                    <!-- Single Category -->
                    <div class="col-12 col-xl-3 col-lg-4 col-sm-6 col-xs-8">
                      <a  class=" border border-color-2 rounded-4 pl- pt-7 pb-7 pr- mb-9 d-block w-100 corods8">
                        <div class=" ">
                    ...
                    <!-- End Single Category -->
                              <!-- Single Category -->
          <div class="col-12 col-xl-3 col-lg-4 col-sm-6 col-xs-8">
            <a  class=" border border-color-2 rounded-4 pl- pt-7 pb-7 pr- mb-9 d-block w-100 corods9">
              <div class=" ">
          ...
          <!-- End Single Category -->
                    <!-- Single Category -->
                    <div class="col-12 col-xl-3 col-lg-4 col-sm-6 col-xs-8">
                      <a  class=" border border-color-2 rounded-4 pl- pt-7 pb-7 pr- mb-9 d-block w-100 corods10">
                        <div class=" ">
                    ...
                    <!-- End Single Category -->  
                              ...
                              <!-- Single Category -->
          <div class="col-12 col-xl-3 col-lg-4 col-sm-6 col-xs-8">
            <a  class=" border border-color-2 rounded-4 pl- pt-7 pb-7 pr- mb-9 d-block w-100 corods11">
              <div class=" ">
          ...
          <!-- End Single Category -->
                    <!-- Single Category -->
                    <div class="col-12 col-xl-3 col-lg-4 col-sm-6 col-xs-8">
                      <a  class=" border border-color-2 rounded-4 pl- pt-7 pb-7 pr- mb-9 d-block w-100 corods12">
                        <div class=" ">
                    ...
                    <!-- End Single Category -->
                              <!-- Single Category -->
          <div class="col-12 col-xl-3 col-lg-4 col-sm-6 col-xs-8">
            <a  class=" border border-color-2 rounded-4 pl- pt-7 pb-7 pr- mb-9 d-block w-100 corods13">
              <div class=" ">
          ...
          <!-- End Single Category -->
                    <!-- Single Category -->
                    <div class="col-12 col-xl-3 col-lg-4 col-sm-6 col-xs-8">
                      <a  class=" border border-color-2 rounded-4 pl- pt-7 pb-7 pr- mb-9 d-block w-100 corods14">
                        <div class=" ">
                    ...
                    <!-- End Single Category -->
                              <!-- Single Category -->
          <div class="col-12 col-xl-3 col-lg-4 col-sm-6 col-xs-8">
            <a  class=" border border-color-2 rounded-4 pl- pt-7 pb-7 pr- mb-9 d-block w-100 corods15">
              <div class=" ">
          ...
          <!-- End Single Category -->
                    <!-- Single Category -->
                    <div class="col-12 col-xl-3 col-lg-4 col-sm-6 col-xs-8">
                      <a  class=" border border-color-2 rounded-4 pl- pt-7 pb-7 pr- mb-9 d-block w-100 corods16">
                        <div class=" ">
                    ...
                    <!-- End Single Category -->
                              <!-- Single Category -->
          <div class="col-12 col-xl-3 col-lg-4 col-sm-6 col-xs-8">
            <a  class=" border border-color-2 rounded-4 pl- pt-7 pb-7 pr- mb-9 d-block w-100 corods17">
              <div class=" ">
